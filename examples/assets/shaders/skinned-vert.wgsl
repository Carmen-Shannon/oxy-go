// Skinned instanced vertex shader
//
...
// and bone_weights. Passes UV coordinates through to the fragment stage for
// texture sampling.
...
fn vs_main(
    ...
    // Transform normal (inverse-transpose approximation via mat3)
    ...
    // Use the original unskinned vertex position so rainbow colors are
    // permanently baked to the mesh surface and don't shift with animation.
